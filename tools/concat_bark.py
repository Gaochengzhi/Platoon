...
import os
before_path = "../res/before_idv_lane_pos_idv_acc"
in_path = "../res/in_idv_lane_pos_idv_acc"
out_path = "../res/out_idv_lane_pos_idv_acc"
images = []

vol_values = ["4500", "5500", "6500", "7500", "8500"]
...
concatenated_image.save(f"../res/out/step_lane_acc.png")
